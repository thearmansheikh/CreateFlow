...
const socialLinks = [
  {
    label: "Twitter",
    href: "https://twitter.com/createflow",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/createflow",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/createflow",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@createflow",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "GitHub",
    href: "https://github.com/thearmansheikh/createflow",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-16">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-xs leading-relaxed mb-6">
              The AI-powered platform for creating and managing content across all platforms.
            </p>
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg glass flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors hover:bg-white/[0.06]"
